...
5명의 학생에게 5개의 사물함을 배정하는데 자기 이름을 넣으면 0에서 4 사이의 사물함 번호를 알려주는 프로그램을 사용했다. 이렇게 사물함을 배정한 후 그 결과를 종이에 적어두었다. 특정 학생의 사물함이 어디인지 종이를 보고 검색한다고 하자. 
